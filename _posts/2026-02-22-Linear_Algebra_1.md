...
Algebra의 뜻을 검색해보면 "숫자 대신 문자(기호)를 사용하여 수의 성질, 관계, 계산 법칙을 연구하는 수학의 한 분야"라고 설명한다. 그럼 Linear Algebra는 당연하게 숫자 대신 선형을 이용하여 수의 성질, 관계, 계산 법칙을 연구하는 것으로 이해할 수 있다. 이를 다른 말로 표현하면 집합 위에 선형연산을 주고 그 행동을 살펴보는 학문이라고도 생각할 수 있다.
